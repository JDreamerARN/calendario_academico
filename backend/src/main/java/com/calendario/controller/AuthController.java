...
import com.calendario.dto.AuthResponse;
import com.calendario.dto.LoginRequest;
import com.calendario.dto.RegisterRequest;
import com.calendario.model.User;
import com.calendario.security.JwtTokenProvider;
import com.calendario.service.UserService;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody RegisterRequest registerRequest) {
        try {
            ...
            return ResponseEntity.ok(new AuthResponse("Usuário registrado com sucesso. Você já pode fazer login."));
